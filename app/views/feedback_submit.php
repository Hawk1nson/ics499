		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item d-flex align-items-center mr-3">
				<div class="custom-control custom-switch theme-switch">
					<input type="checkbox" class="custom-control-input" id="themeToggleFeedbackSubmit" data-theme-toggle />
					<label class="custom-control-label" for="themeToggleFeedbackSubmit">Dark mode</label>
				</div>
			</li>
			<li class="nav-item">
